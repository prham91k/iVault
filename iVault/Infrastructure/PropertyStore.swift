...
public protocol PropertyStoreProtocol {
    ...
    var legalAcceptedVersion: String { get set }
}
...
public class PropertyStore: PropertyStoreProtocol {
    ...
    private let TagLegalAcceptedVersion = "LegalAcceptedVersion"
    ...
    public var legalAcceptedVersion: String {
        get {
            if let version = self.defaultStore.object(forKey: TagLegalAcceptedVersion) as? String {
                return version
            }
            return "0.0.0";
        }
        set {
            self.defaultStore.set(newValue, forKey: TagLegalAcceptedVersion)
        }
    }
}
